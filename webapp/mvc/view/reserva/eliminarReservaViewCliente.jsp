...
%>
		<form onsubmit="return validarFormatoPassword()" id="myForm" action="/practica3/eliminarReservaClienteControllerServlet" method="post">

			<label class="container">Fecha de la reserva a eliminar: <select name="id_reserva"> 
