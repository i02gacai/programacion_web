 ...
 */
@WebServlet("/realizarModificarReservaBonoControllerServlet")
public class realizarModificarReservaBonoControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public realizarModificarReservaBonoControllerServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Object reservaObj = request.getParameter("reserva");
        ...
        int id_reserva = reserva.getId_reserva();
		...
		try {
			...
			reservaDao.modificarReserva(customerBean.getCorreo(), id_pista, fecha_, duracion, hora, precio, descuento, numero_adultos, numero_ninos,id_reserva, sql);
			bonoDao.actualizarSesionesBono(n_sesiones-1, id_bono, sql);
			RequestDispatcher rd;
			request.setAttribute("mensaje", "&iexclReserva modificada con &eacutexito!");
