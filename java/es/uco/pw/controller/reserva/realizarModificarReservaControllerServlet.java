 ...
 */
@WebServlet("/realizarModificarReservaControllerServlet")
public class realizarModificarReservaControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public realizarModificarReservaControllerServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(request.getParameter("tipo").equals("individual")) {
