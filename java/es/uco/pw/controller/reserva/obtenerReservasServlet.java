 ...
 */
@WebServlet("/obtenerReservasServlet")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			reservaDAO reservaDao = new reservaDAO(BDdriver, BDurl, BDuser, BDpass);
				...
				lista.setReservas(reservaDao.obtenerReservas(LocalDate.now(),sql));
				request.setAttribute("lista_reservas", lista);
				RequestDispatcher rd;
				rd = request.getRequestDispatcher("/mvc/view/reserva/eliminarReservaViewAdmin.jsp");
